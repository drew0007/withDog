...
public class SnsServiceImpl implements SnsService{
	...
	public JSONObject AshKakaoPay(Point point, String uri) throws Exception {
	    ...
	    params.add("tax_free_amount", "0");//세금
	    params.add("approval_url", uri+"0");
	    params.add("cancel_url", "http://192.168.0.39:8080/ash/addReservationASHViewAndroid?state=1");
	    params.add("fail_url", "http://192.168.0.39:8080/ash/addReservationASHViewAndroid?state=2");
