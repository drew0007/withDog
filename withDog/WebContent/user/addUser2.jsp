...
<script src="//code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
	...
	$( function() {
		...
		$("#passwordCheck").on("keyup",function(){ 
			...
			if(pw!=pwCheck){
				$(".changeSpan1").html("비밀번호가 일치하지 않습니다.").css('color','red');
			}else{
				
				$(".changeSpan1").html("비밀번호 일치").css('color','blue');
			}		
...
<!--                                 <button class="highlight-button btn no-margin pull-right post-search" id="searchPost">우편번호 검색</button> -->
                                <input type="button" id="searchPost" value="우편번호 검색">
